window.abrirModalNovoPedido = function() {
                ...
                const labelArea = modoAdmin ? 'Área / Departamento' : 'Departamento Aksanti';
                const destinoInterno = modoColaborador ? 'Aksanti - Administração' : 'Aksanti';
                ...
                document.getElementById('btn-submeter-pedido').addEventListener('click', () => {
                    ...
                    const faltamDadosDestino = modoAdmin && (
                        dados.destination_type === 'AKSANTI'
                            ? (!dados.recipient_user_id || !dados.client_email)
