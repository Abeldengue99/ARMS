/**
 * ARMS — Lógica Dedicada da Gestão de Pedidos (pedidos.html)
 */
document.addEventListener('DOMContentLoaded', () => {
    // Botão de criar pedido e modal com dados reais do PostgreSQL
    const btnCriar = document.getElementById('btn-criar-pedido');
    if (btnCriar) {
        btnCriar.addEventListener('click', () => {
            ...
            if (campoDeadline) {
                ...
                campoDeadline.min = hoje;
            }

            // Ligar o botão de submeter à API
            const btnSubmeter = document.getElementById('btn-submeter-pedido');
            if (btnSubmeter) {
